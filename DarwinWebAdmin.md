...
- The current AI/integration checkpoint keeps real provider calls, direct operational AI executors, two-way sync, and accounting API push blocked until their concrete target, owner, payload, policy, and smoke strategy are selected. This is deliberate sequencing; internal evidence and task routing remain the only active AI execution surfaces.
