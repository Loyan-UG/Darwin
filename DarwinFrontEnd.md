...
## 17. Historical Hardening Notes

Detailed chronological hardening notes have been preserved in [docs/implementation-ledger.md](docs/implementation-ledger.md). Keep this guide focused on active front-office boundaries, page architecture, API rules, localization, security, and delivery planning.
