...
namespace Darwin.Application.CRM.Queries
{
    public sealed class GetOpportunitiesPageHandler
    {
        ...
        public GetOpportunitiesPageHandler(IAppDbContext db, IClock? clock = null)
        {
            ...
            CancellationToken ct = default)
        {
            ...
            var items = await baseQuery
                ...
                .Select(x => new OpportunityListItemDto
                {
                    ...
                    Currency = x.opportunity.Currency,
                    Stage = x.opportunity.Stage,
                    ProbabilityPercent = x.opportunity.ProbabilityPercent,
                    ForecastCategory = x.opportunity.ForecastCategory,
                    ...
                    ClosedAtUtc = x.opportunity.ClosedAtUtc,
                    CloseReason = x.opportunity.CloseReason,
                    Source = x.opportunity.Source,
