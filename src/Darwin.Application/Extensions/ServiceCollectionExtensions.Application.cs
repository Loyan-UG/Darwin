...
namespace Darwin.Application.Extensions
{
    ...
    public static class ServiceCollectionExtensionsApplication
    {
        public static IServiceCollection AddApplication(this IServiceCollection services, IConfiguration? configuration = null)
        {
            ...
            services.AddScoped<AiScopedContextProjectionService>();
            services.AddScoped<AiProviderAdapterFoundationService>();
            services.AddScoped<AiActionHandoffService>();
            services.AddScoped<InternalFollowUpTaskService>();
            services.AddScoped<IAiActionDraftExecutor, AiTimelineActionDraftExecutor>();
