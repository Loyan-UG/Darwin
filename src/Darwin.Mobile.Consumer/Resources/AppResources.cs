...
public static class AppResources
{
    ...
    public static string RewardsTransactionTypeAccrual => ResourceManager.GetString(nameof(RewardsTransactionTypeAccrual), Culture) ?? "Accrual";
    public static string RewardsTransactionTypeRedemption => ResourceManager.GetString(nameof(RewardsTransactionTypeRedemption), Culture) ?? "Redemption";
    public static string RewardsTransactionTypeAdjustment => ResourceManager.GetString(nameof(RewardsTransactionTypeAdjustment), Culture) ?? "Adjustment";
    public static string RewardsTransactionTypeUnknown => ResourceManager.GetString(nameof(RewardsTransactionTypeUnknown), Culture) ?? "Other transaction";
    ...
    public static string ProfilePhoneVerificationSectionTitle => ResourceManager.GetString(nameof(ProfilePhoneVerificationSectionTitle), Culture) ?? "Phone verification";
    public static string ProfilePhoneVerificationConfirmed => ResourceManager.GetString(nameof(ProfilePhoneVerificationConfirmed), Culture) ?? "Your current phone number is verified.";
    public static string ProfilePhoneVerificationPending => ResourceManager.GetString(nameof(ProfilePhoneVerificationPending), Culture) ?? "Your current phone number still needs verification before SMS and WhatsApp follow-up are fully ready.";
    public static string ProfilePhoneVerificationChannelLabel => ResourceManager.GetString(nameof(ProfilePhoneVerificationChannelLabel), Culture) ?? "Verification channel";
    public static string ProfilePhoneVerificationSmsOption => ResourceManager.GetString(nameof(ProfilePhoneVerificationSmsOption), Culture) ?? "SMS";
    public static string ProfilePhoneVerificationWhatsAppOption => ResourceManager.GetString(nameof(ProfilePhoneVerificationWhatsAppOption), Culture) ?? "WhatsApp";
    public static string ProfilePhoneVerificationCodeLabel => ResourceManager.GetString(nameof(ProfilePhoneVerificationCodeLabel), Culture) ?? "Verification code";
    public static string ProfilePhoneVerificationCodePlaceholder => ResourceManager.GetString(nameof(ProfilePhoneVerificationCodePlaceholder), Culture) ?? "Enter the code you received";
    public static string ProfilePhoneVerificationRequestButton => ResourceManager.GetString(nameof(ProfilePhoneVerificationRequestButton), Culture) ?? "Request code";
    public static string ProfilePhoneVerificationConfirmButton => ResourceManager.GetString(nameof(ProfilePhoneVerificationConfirmButton), Culture) ?? "Confirm code";
    public static string ProfilePhoneVerificationPhoneRequired => ResourceManager.GetString(nameof(ProfilePhoneVerificationPhoneRequired), Culture) ?? "Add a phone number to your profile before requesting verification.";
    public static string ProfilePhoneVerificationCodeRequired => ResourceManager.GetString(nameof(ProfilePhoneVerificationCodeRequired), Culture) ?? "Enter the verification code before confirming your phone number.";
    public static string ProfilePhoneVerificationCodeRequested => ResourceManager.GetString(nameof(ProfilePhoneVerificationCodeRequested), Culture) ?? "A verification code was requested through {0}.";
    public static string ProfilePhoneVerificationRequestFailed => ResourceManager.GetString(nameof(ProfilePhoneVerificationRequestFailed), Culture) ?? "Unable to request a verification code right now.";
    public static string ProfilePhoneVerificationConfirmSuccess => ResourceManager.GetString(nameof(ProfilePhoneVerificationConfirmSuccess), Culture) ?? "Phone number confirmed successfully.";
    public static string ProfilePhoneVerificationConfirmFailed => ResourceManager.GetString(nameof(ProfilePhoneVerificationConfirmFailed), Culture) ?? "Phone verification could not be completed right now.";
    ...
    public static string MemberCustomerContextConsentTypeMarketingEmail => ResourceManager.GetString(nameof(MemberCustomerContextConsentTypeMarketingEmail), Culture) ?? "Marketing email";
    public static string MemberCustomerContextConsentTypeTermsOfService => ResourceManager.GetString(nameof(MemberCustomerContextConsentTypeTermsOfService), Culture) ?? "Terms of service";
    public static string MemberCustomerContextConsentTypeUnknown => ResourceManager.GetString(nameof(MemberCustomerContextConsentTypeUnknown), Culture) ?? "Other consent";
    ...
    public static string MemberCustomerContextInteractionTypeCall => ResourceManager.GetString(nameof(MemberCustomerContextInteractionTypeCall), Culture) ?? "Call";
    public static string MemberCustomerContextInteractionTypeMeeting => ResourceManager.GetString(nameof(MemberCustomerContextInteractionTypeMeeting), Culture) ?? "Meeting";
    public static string MemberCustomerContextInteractionTypeOrder => ResourceManager.GetString(nameof(MemberCustomerContextInteractionTypeOrder), Culture) ?? "Order";
    public static string MemberCustomerContextInteractionTypeSupport => ResourceManager.GetString(nameof(MemberCustomerContextInteractionTypeSupport), Culture) ?? "Support";
    public static string MemberCustomerContextInteractionTypeUnknown => ResourceManager.GetString(nameof(MemberCustomerContextInteractionTypeUnknown), Culture) ?? "Other interaction";
    public static string MemberCustomerContextInteractionChannelChat => ResourceManager.GetString(nameof(MemberCustomerContextInteractionChannelChat), Culture) ?? "Chat";
    public static string MemberCustomerContextInteractionChannelInPerson => ResourceManager.GetString(nameof(MemberCustomerContextInteractionChannelInPerson), Culture) ?? "In person";
    public static string MemberCustomerContextInteractionChannelUnknown => ResourceManager.GetString(nameof(MemberCustomerContextInteractionChannelUnknown), Culture) ?? "Other channel";
    ...
    public static string MemberCommerceStatusPaid => ResourceManager.GetString(nameof(MemberCommerceStatusPaid), Culture) ?? "Paid";
    public static string MemberCommerceStatusPartiallyShipped => ResourceManager.GetString(nameof(MemberCommerceStatusPartiallyShipped), Culture) ?? "Partially shipped";
    public static string MemberCommerceStatusShipped => ResourceManager.GetString(nameof(MemberCommerceStatusShipped), Culture) ?? "Shipped";
    public static string MemberCommerceStatusDelivered => ResourceManager.GetString(nameof(MemberCommerceStatusDelivered), Culture) ?? "Delivered";
    public static string MemberCommerceStatusCancelled => ResourceManager.GetString(nameof(MemberCommerceStatusCancelled), Culture) ?? "Cancelled";
    public static string MemberCommerceStatusRefunded => ResourceManager.GetString(nameof(MemberCommerceStatusRefunded), Culture) ?? "Refunded";
    public static string MemberCommerceStatusPartiallyRefunded => ResourceManager.GetString(nameof(MemberCommerceStatusPartiallyRefunded), Culture) ?? "Partially refunded";
    public static string MemberCommerceStatusCompleted => ResourceManager.GetString(nameof(MemberCommerceStatusCompleted), Culture) ?? "Completed";
    public static string MemberCommerceStatusDraft => ResourceManager.GetString(nameof(MemberCommerceStatusDraft), Culture) ?? "Draft";
    public static string MemberCommerceStatusOpen => ResourceManager.GetString(nameof(MemberCommerceStatusOpen), Culture) ?? "Open";
    public static string MemberCommerceStatusUnknown => ResourceManager.GetString(nameof(MemberCommerceStatusUnknown), Culture) ?? "Status update";
    ...
    public static string BusinessRewardTypeFreeItem => ResourceManager.GetString(nameof(BusinessRewardTypeFreeItem), Culture) ?? "Free item";
    public static string BusinessRewardTypePercentDiscount => ResourceManager.GetString(nameof(BusinessRewardTypePercentDiscount), Culture) ?? "Percent discount";
    public static string BusinessRewardTypeAmountDiscount => ResourceManager.GetString(nameof(BusinessRewardTypeAmountDiscount), Culture) ?? "Amount discount";
    public static string BusinessRewardTypeUnknown => ResourceManager.GetString(nameof(BusinessRewardTypeUnknown), Culture) ?? "Reward";
    ...
    public static string FeedTimelineKindPointsTransaction => ResourceManager.GetString(nameof(FeedTimelineKindPointsTransaction), Culture) ?? "Points activity";
    public static string FeedTimelineKindRewardRedemption => ResourceManager.GetString(nameof(FeedTimelineKindRewardRedemption), Culture) ?? "Reward redemption";
