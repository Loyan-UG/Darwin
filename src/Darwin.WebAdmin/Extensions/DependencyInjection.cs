...
namespace Darwin.WebAdmin.Extensions
{
    ...
    public static class DependencyInjection
    {
        ...
        public static IServiceCollection AddWebComposition(this IServiceCollection services, IConfiguration config)
        {
            ...
            // Human Resources
            services.AddScoped<GetEmployeesPageHandler>();
            services.AddScoped<GetEmployeeDetailHandler>();
            services.AddScoped<CreateEmployeeHandler>();
            services.AddScoped<UpdateEmployeeHandler>();
            services.AddScoped<ArchiveEmployeeHandler>();
            services.AddScoped<GetDepartmentsPageHandler>();
            services.AddScoped<GetDepartmentDetailHandler>();
            services.AddScoped<CreateDepartmentHandler>();
            services.AddScoped<UpdateDepartmentHandler>();
            services.AddScoped<ArchiveDepartmentHandler>();
            services.AddScoped<GetPositionsPageHandler>();
            services.AddScoped<GetPositionDetailHandler>();
            services.AddScoped<CreatePositionHandler>();
            services.AddScoped<UpdatePositionHandler>();
            services.AddScoped<ArchivePositionHandler>();
            services.AddScoped<GetEmploymentContractsPageHandler>();
            services.AddScoped<GetEmploymentContractDetailHandler>();
            services.AddScoped<CreateEmploymentContractHandler>();
            services.AddScoped<UpdateEmploymentContractHandler>();
            services.AddScoped<ArchiveEmploymentContractHandler>();
            services.AddScoped<GetWorkSchedulesPageHandler>();
            services.AddScoped<GetWorkScheduleDetailHandler>();
            services.AddScoped<CreateWorkScheduleHandler>();
            services.AddScoped<UpdateWorkScheduleHandler>();
            services.AddScoped<ArchiveWorkScheduleHandler>();
            services.AddScoped<CreateWorkScheduleExceptionHandler>();
            services.AddScoped<GetAttendanceEventsPageHandler>();
            services.AddScoped<CreateAttendanceEventHandler>();
            services.AddScoped<GetTimeEntriesPageHandler>();
            services.AddScoped<GetTimeEntryDetailHandler>();
            services.AddScoped<CreateTimeEntryHandler>();
            services.AddScoped<UpdateTimeEntryHandler>();
            services.AddScoped<GetTimesheetsPageHandler>();
            services.AddScoped<GetTimesheetDetailHandler>();
            services.AddScoped<CreateTimesheetHandler>();
            services.AddScoped<UpdateTimesheetHandler>();
            services.AddScoped<UpdateTimesheetLifecycleHandler>();
            services.AddScoped<GetLeaveRequestsPageHandler>();
            services.AddScoped<GetLeaveRequestDetailHandler>();
            services.AddScoped<CreateLeaveRequestHandler>();
            services.AddScoped<UpdateLeaveRequestHandler>();
            services.AddScoped<UpdateLeaveRequestLifecycleHandler>();
            services.AddScoped<GetAbsenceRecordsPageHandler>();
            services.AddScoped<GetAbsenceRecordDetailHandler>();
            services.AddScoped<CreateAbsenceRecordHandler>();
            services.AddScoped<UpdateAbsenceRecordHandler>();
            services.AddScoped<GetPayrollPeriodsPageHandler>();
            services.AddScoped<GetPayrollPeriodDetailHandler>();
            services.AddScoped<CreatePayrollPeriodHandler>();
            services.AddScoped<UpdatePayrollPeriodHandler>();
            services.AddScoped<PreparePayrollPeriodSummaryHandler>();
            services.AddScoped<UpdatePayrollPeriodLifecycleHandler>();
            services.AddScoped<GetPayrollRuleSetsPageHandler>();
            services.AddScoped<GetPayrollRuleSetDetailHandler>();
            services.AddScoped<CreatePayrollRuleSetHandler>();
            services.AddScoped<UpdatePayrollRuleSetHandler>();
            services.AddScoped<ArchivePayrollRuleSetHandler>();
            services.AddScoped<UpsertPayrollRuleComponentHandler>();
            services.AddScoped<ArchivePayrollRuleComponentHandler>();
            services.AddScoped<GetPayrollRunsPageHandler>();
            services.AddScoped<GetPayrollRunDetailHandler>();
            services.AddScoped<CreatePayrollRunHandler>();
            services.AddScoped<CalculatePayrollRunHandler>();
            services.AddScoped<UpdatePayrollRunLifecycleHandler>();
            services.AddScoped<PostPayrollRunHandler>();
            services.AddScoped<PayrollPayslipArtifactService>();
            services.AddScoped<PayrollPaymentWorkflowPolicy>();
            services.AddScoped<GetPayrollPaymentsPageHandler>();
            services.AddScoped<GetPayrollPaymentDetailHandler>();
            services.AddScoped<GetPayrollPaymentDraftHandler>();
            services.AddScoped<CreatePayrollPaymentHandler>();
            services.AddScoped<UpdatePayrollPaymentHandler>();
            services.AddScoped<PostPayrollPaymentHandler>();
            services.AddScoped<CancelPayrollPaymentHandler>();
            services.AddScoped<ReversePayrollPaymentHandler>();
            services.AddScoped<SettlePayrollPaymentFromBankReconciliationHandler>();
            services.AddScoped<CreatePayrollPaymentBankCorrectionHandler>();
            services.AddScoped<PostPayrollPaymentBankCorrectionHandler>();
            services.AddScoped<CancelPayrollPaymentBankCorrectionHandler>();
            services.AddScoped<PersonnelDocumentService>();
            ...
            services.AddScoped<SettleSupplierPaymentFromBankReconciliationHandler>();
            services.AddScoped<CreateSupplierPaymentBankCorrectionHandler>();
            services.AddScoped<PostSupplierPaymentBankCorrectionHandler>();
            services.AddScoped<CancelSupplierPaymentBankCorrectionHandler>();
            services.AddScoped<GetSupplierAdvancesPageHandler>();
            services.AddScoped<GetSupplierAdvanceDetailHandler>();
            services.AddScoped<GetSupplierAdvanceDraftHandler>();
            services.AddScoped<SupplierAdvanceWorkflowPolicy>();
            services.AddScoped<CreateSupplierAdvanceHandler>();
            services.AddScoped<UpdateSupplierAdvanceHandler>();
            services.AddScoped<PostSupplierAdvanceHandler>();
            services.AddScoped<CancelSupplierAdvanceHandler>();
            services.AddScoped<ReverseSupplierAdvanceHandler>();
            services.AddScoped<ApplySupplierAdvanceHandler>();
            services.AddScoped<ReverseSupplierAdvanceApplicationHandler>();
            services.AddScoped<GetBankAccountsPageHandler>();
            services.AddScoped<GetBankAccountForEditHandler>();
            services.AddScoped<CreateBankAccountHandler>();
            services.AddScoped<UpdateBankAccountHandler>();
            services.AddScoped<ArchiveBankAccountHandler>();
            services.AddScoped<GetBankStatementsPageHandler>();
            services.AddScoped<GetBankStatementImportDetailHandler>();
            services.AddScoped<CreateBankStatementImportHandler>();
            services.AddScoped<CancelBankStatementImportHandler>();
            services.AddScoped<GetBankReconciliationPageHandler>();
            services.AddScoped<GetBankReconciliationDetailHandler>();
            services.AddScoped<GetBankReconciliationDraftHandler>();
            services.AddScoped<CreateBankReconciliationMatchHandler>();
            services.AddScoped<UpdateBankReconciliationMatchHandler>();
            services.AddScoped<MarkBankReconciliationMatchedHandler>();
            services.AddScoped<CancelBankReconciliationMatchHandler>();
            services.AddScoped<GetAiGovernanceReviewPageHandler>();
            services.AddScoped<GetAiRecommendationDetailHandler>();
            services.AddScoped<GetAiActionDraftDetailHandler>();
            services.AddScoped<GetInternalFollowUpTasksPageHandler>();
            services.AddScoped<GetInternalFollowUpTaskDetailHandler>();
            ...
            services.AddScoped<GetWarehouseLocationsPageHandler>();
            services.AddScoped<GetWarehouseLocationDetailHandler>();
            services.AddScoped<GetWarehouseLocationTreeHandler>();
            services.AddScoped<CreateWarehouseLocationHandler>();
            services.AddScoped<UpdateWarehouseLocationHandler>();
            services.AddScoped<ArchiveWarehouseLocationHandler>();
            services.AddScoped<GetProductTrackingPoliciesPageHandler>();
            services.AddScoped<GetProductTrackingPolicyDetailHandler>();
            services.AddScoped<CreateProductTrackingPolicyHandler>();
            services.AddScoped<UpdateProductTrackingPolicyHandler>();
            services.AddScoped<ArchiveProductTrackingPolicyHandler>();
            services.AddScoped<GetInventoryLotsPageHandler>();
            services.AddScoped<GetInventoryLotDetailHandler>();
            services.AddScoped<CreateInventoryLotHandler>();
            services.AddScoped<UpdateInventoryLotHandler>();
            services.AddScoped<ArchiveInventoryLotHandler>();
            services.AddScoped<GetInventorySerialUnitsPageHandler>();
            services.AddScoped<GetInventorySerialUnitDetailHandler>();
            services.AddScoped<CreateInventorySerialUnitHandler>();
            services.AddScoped<UpdateInventorySerialUnitHandler>();
            services.AddScoped<ArchiveInventorySerialUnitHandler>();
            services.AddScoped<GetHandlingUnitsPageHandler>();
            services.AddScoped<GetHandlingUnitDetailHandler>();
            services.AddScoped<CreateHandlingUnitHandler>();
            services.AddScoped<UpdateHandlingUnitHandler>();
            services.AddScoped<ArchiveHandlingUnitHandler>();
            services.AddScoped<GetWarehouseLabelTemplatesPageHandler>();
            services.AddScoped<GetWarehouseLabelTemplateDetailHandler>();
            services.AddScoped<RenderWarehouseLocationLabelsHandler>();
            services.AddScoped<CreateWarehouseLabelTemplateHandler>();
            services.AddScoped<UpdateWarehouseLabelTemplateHandler>();
            services.AddScoped<ArchiveWarehouseLabelTemplateHandler>();
            services.AddScoped<WarehouseTaskWorkflowPolicy>();
            services.AddScoped<GetWarehouseTasksPageHandler>();
            services.AddScoped<GetWarehouseTaskDetailHandler>();
            services.AddScoped<CreateWarehouseTaskHandler>();
            services.AddScoped<UpdateWarehouseTaskHandler>();
            services.AddScoped<UpdateWarehouseTaskLifecycleHandler>();
            services.AddScoped<GetStockCountsPageHandler>();
            services.AddScoped<GetStockCountDetailHandler>();
            services.AddScoped<CreateStockCountHandler>();
            services.AddScoped<UpdateStockCountHandler>();
            services.AddScoped<UpdateStockCountLifecycleHandler>();
            services.AddScoped<CreateWarehouseReceivingTaskFromGoodsReceiptHandler>();
            services.AddScoped<CreateWarehousePutawayTaskFromGoodsReceiptHandler>();
            services.AddScoped<CreateWarehousePickingTaskFromOrderHandler>();
            ...
            services.AddScoped<CreateSupplierContactHandler>();
            services.AddScoped<UpdateSupplierContactHandler>();
            services.AddScoped<ArchiveSupplierContactHandler>();
            services.AddScoped<RegisterSupplierDocumentHandler>();
            services.AddScoped<GetStockLevelsPageHandler>();
            services.AddScoped<GetBinStockDerivationHandler>();
        ...
        services.AddScoped<UpdateCreditNoteLifecycleHandler>();
            ...
            services.AddScoped<CreateGoodsReceiptInlineIdentityHandler>();
