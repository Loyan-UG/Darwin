    ...
    public sealed class SiteSettingsSeedSection
    {
        ...
        public async Task SeedAsync(DarwinDbContext db, CancellationToken ct = default)
        {
            ...
            var s = new SiteSetting
            {
                ...
                SmtpPassword = "",
                SmtpFromAddress = "no-reply@loyan.de",
                SmtpFromDisplayName = "Loyan",
                ...
                BrevoApiKey = null,
                BrevoWebhookUsername = null,
                BrevoWebhookPassword = null,
                BrevoSandboxMode = true,
                BrevoTestRecipientEmail = null,

                // Admin alert channels (email/SMS to ops)
                AdminAlertEmailsCsv = "dev@loyan.de",
