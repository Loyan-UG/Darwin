        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RunNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    SourceSnapshotJson = table.Column<string>(type: "nvarchar(max)", maxLength: 16000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmploymentContractId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    EmployerCostMinor = table.Column<long>(type: "bigint", nullable: false),
                    NetPayMinor = table.Column<long>(type: "bigint", nullable: false),
                    EmployeeSnapshotJson = table.Column<string>(type: "nvarchar(max)", maxLength: 16000, nullable: true),
                    ContractSnapshotJson = table.Column<string>(type: "nvarchar(max)", maxLength: 16000, nullable: true),
                    PeriodLineSnapshotJson = table.Column<string>(type: "nvarchar(max)", maxLength: 16000, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifiedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayrollRuleComponentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    RuleSnapshotJson = table.Column<string>(type: "nvarchar(max)", maxLength: 16000, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifiedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
