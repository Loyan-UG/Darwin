        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyncScope = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ...
                    LastErrorSummary = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    RemoteVersion = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    LocalVersion = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SyncStateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExternalSystemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EntityType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    EntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Direction = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    ...
                    ConflictKey = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    FieldPath = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    DarwinValueSummary = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ExternalValueSummary = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ResolutionSummary = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
