        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reason = table.Column<string>(type: "nvarchar(48)", maxLength: 48, nullable: false),
                    ...
                    SourceModelJson = table.Column<string>(type: "nvarchar(max)", maxLength: 32000, nullable: false),
                    SourceModelHashSha256 = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ArchiveGeneratedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ArchiveRetainUntilUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ArchiveRetentionPolicyVersion = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    ArchivePurgedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ArchivePurgeReason = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalTaxMinor = table.Column<long>(type: "bigint", nullable: false),
                    TotalGrossMinor = table.Column<long>(type: "bigint", nullable: false),
                    SourceLineJson = table.Column<string>(type: "nvarchar(max)", maxLength: 16000, nullable: false),
            ...
            migrationBuilder.CreateIndex("IX_CreditNotes_CreditNoteNumber", "CreditNotes", "CreditNoteNumber", schema: "Sales", unique: true, filter: "[CreditNoteNumber] IS NOT NULL AND [IsDeleted] = 0");
