        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountNumber = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    CountType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Status = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    CountWindowStartUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CountWindowEndUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    ReviewRequestedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VarianceQuantity = table.Column<int>(type: "integer", nullable: false),
                    ReviewStatus = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    AdjustmentPosted = table.Column<bool>(type: "boolean", nullable: false),
                    ReviewNotes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "\"CountNumber\" IS NOT NULL AND \"IsDeleted\" = FALSE");
