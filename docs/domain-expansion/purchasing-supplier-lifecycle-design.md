...
- Supplier invoice/payables boundary design is complete, and the formal supplier invoice core model/admin workflow plus payable posting are implemented before supplier payment settlement.
...
7. `Warehouse Receiving Task Design Slice`
