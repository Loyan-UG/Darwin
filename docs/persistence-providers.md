...
Current validation expectations are code-backed by the provider migration lanes, source-contract tests, and go-live scripts. Historical local smoke results and dated runtime validation notes belong in [docs/implementation-ledger.md](implementation-ledger.md), not in this persistence architecture guide.
